...
+ [\frac{P_i(3t_{i-1})}{(t_{i+2} - t_{i-1})(t_{i+1} - t_{i-1})(t_i - t_{i-1})}  -  \frac{P_{i-1}(t_{i-2}^2+2t_{i-2}t_{i+2})}{(t_{i+2} - t_{i-1})(t_{i-1} - t_{i-2})(t_i - t_{i-2})}\\
